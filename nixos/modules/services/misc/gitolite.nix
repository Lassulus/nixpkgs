...
#
# example: we want a repo named testrepo where the user testuser has read and write permissions.
#
# services.gitolite = {
#   mutable = false;
#   keys = {
#     testuser = "ssh-rsa AAAA...== testuser@somepc";
#   };
#   repos = {
#     testrepo = {
#       testuser = "RW";
...
let
  ...
  # writeCommonHooks :: string -> string
  ...
  # copyRepoSpecificHooks :: string -> string
  ...
  # writeCustomFile :: customFile -> string
  ...
  # either2script :: string -> either string path -> path
